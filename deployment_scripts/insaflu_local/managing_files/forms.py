        ...
        try:
            ...
            try:
                ...
                (is_fastq, type_of_fastq) = self.utils.is_fastq_gz(
                    fastaq_temp_file_name.name
                )
                self.cleaned_data[
                    "type_fastq"
                ] = type_of_fastq  ### pass info to SamplesAddView
            ...
            print("####################")
            print("type of fastq", type_of_fastq)
            ...
            HTML(
                ...
                + mark_safe(
                    os.path.join(
                        ...
                        Constants.FILE_TEMPLATE_INPUT_csv,
                    )
                )
                + '" download> <span> <i class="fa fa-download"></i></span> Template file \'csv\'</a> </div>'
            ),
            HTML("<p> </p>"),
            HTML(
                '<div class="alert alert-dark"> <a href="'
            ...
            HTML(
                ...
                + mark_safe(
                    os.path.join(
                        getattr(settings, "STATIC_URL", None),
                        Constants.DIR_TEMPLATE_INPUT,
                        Constants.FILE_TEMPLATE_INPUT_data_csv,
                    )
                )
                + '" download> <span> <i class="fa fa-download"></i></span> Example Template file \'csv\'</a> </div>'
            ),
            HTML("<p> </p>"),
            HTML(
                '<div class="alert alert-dark"> <a href="'
