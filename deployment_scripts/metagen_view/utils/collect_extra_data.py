            ...
            if (
                ...
                if os.path.exists(file_alignments):
                    ...
                    file_aln2pheno_flagged_COG_UK = project.get_global_file_by_project(
                        TypePath.MEDIA_ROOT,
                        Project.PROJECT_FILE_NAME_Aln2pheno_flagged_COG_UK,
                    )
                    ...
                    if not os.path.exists(file_alignments):
                        self.logger_debug.info(
                            "Collect aln2pheno: error getting pangolin lineage: file does not exist {}".format(
                                file_alignments
                            )
                        )
                        process_SGE.set_process_controler(
                    ...
                    report_data = pandas.read_csv(
                        tmp_aln2pheno, delimiter=Constants.SEPARATOR_TAB
                    )
                    ...
                    report_data.to_csv(
                        file_aln2pheno_report_COG_UK,
                        sep=Constants.SEPARATOR_TAB,
                        index=False,
                    )
                    ...
                    file_aln2pheno_report_pokay = project.get_global_file_by_project(
                        TypePath.MEDIA_ROOT,
                        Project.PROJECT_FILE_NAME_Aln2pheno_report_pokay,
                    )
                    file_aln2pheno_flagged_pokay = project.get_global_file_by_project(
                        TypePath.MEDIA_ROOT,
                        Project.PROJECT_FILE_NAME_Aln2pheno_flagged_pokay,
                    )
                    ...
                    self.utils.copy_file(
                        SoftwareNames.SOFTWARE_ALN2PHENO_README, temp_dir
                    )
